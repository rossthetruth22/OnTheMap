//
//  TableViewVCTableViewController.swift
//  OnTheMap
//
...
class TableViewVC: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = ParseClient.sharedInstance().studentInformation[indexPath.row].wholeName
        cell.detailTextLabel?.text = ParseClient.sharedInstance().studentInformation[indexPath.row].mediaURL
